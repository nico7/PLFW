...
#define SET_HIGH_HOL_ADDR   0x10    // to 0x1F
...
#define SET_DC_DC_ON        0x8A
#define SET_DC_DC_OFF       0x8B
...
#define SET_COM_PADS_CFG_DATA 0x0x02    // to 0x12
#define SET_VCOM_DESEL_LVL_MODE 0xDB
#define SET_VCOM_DESEL_LVL_DATA 0x00    // to 0xFF
